...
class DostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dost" do
    assert_difference('Dost.count') do
      post dosts_url, params: { dost: { email: @dost.email, first_name: @dost.first_name, ladt_name: @dost.ladt_name, phone: @dost.phone, twitter: @dost.twitter } }
    end
  ...
  test "should update dost" do
    patch dost_url(@dost), params: { dost: { email: @dost.email, first_name: @dost.first_name, ladt_name: @dost.ladt_name, phone: @dost.phone, twitter: @dost.twitter } }
